...
class _FoulPlayConfig:
    ...
    password: str | None
    bot1username: str
    bot1password: str | None
    bot2username: str
    bot2password: str | None
    user_id: str
    avatar: str
    bot_mode: BotModes
    pokemon_format: str = ""
    ...
    def configure(self):
        ...
        parser.add_argument("--bot1-username", default=None, help="Username for bot 1 (multi-bot mode)")
        parser.add_argument("--bot1-password", default=None, help="Password for bot 1 (multi-bot mode)")
        parser.add_argument("--bot2-username", default=None, help="Username for bot 2 (multi-bot mode)")
        parser.add_argument("--bot2-password", default=None, help="Password for bot 2 (multi-bot mode)")
        parser.add_argument(
        ...
        self.bot1username = args.bot1_username
        self.bot1password = args.bot1_password
        self.bot2username = args.bot2_username
        self.bot2password = args.bot2_password
